const CACHE='kmreg-test-shell-0.31.10-test.57';
...
const QUICK_ACTIONS='./shell-quick-actions.js?v=0.31.10-test.57';
const SHELL=['./','./index.html','./log-json-v2.js?v=2.0.0',SHARED_UI,REMOVAL_POLICY,BACKUP_ARCHIVE,QUICK_ACTIONS,'./shell-ui.js?v=0.31.10-test.34','./shell-ui-stable.js?v=0.31.10-test.47','./shell-gestures.js?v=0.31.10-test.47','./shell-time-layout.js?v=0.31.10-test.48','./shell-location-status.js?v=0.31.10-test.56','./shell-removal-policy.js?v=0.31.10-test.55','./id-converter.html','./manifest.webmanifest','./app-icon.svg','./config/modules.json','./time/index.html','./time/app.js','./time/styles.css','./time/home-layout.css','./time/home-layout.js','./time/home-top.css','./time/home-top.js','./time/removal-policy-ui.js?v=0.31.10-test.55','./time/quick-actions.js?v=0.31.10-test.57'];
...
function injectShellScript(response){
  ...
  return response.text().then(html=>{
    ...
    html=html.replace(/shell-quick-actions\.js\?v=[^"'<>]+/g,'shell-quick-actions.js?v=0.31.10-test.57');
    ...
    if(!html.includes('shell-quick-actions.js'))injection+=`<script src="./shell-quick-actions.js?v=0.31.10-test.57"></script>`;

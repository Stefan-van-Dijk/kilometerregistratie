const CACHE='kmreg-test-shell-0.31.10-test.1';
const SHELL=['./','./index.html','./shell-ui.js?v=0.31.10-test.1','./shell-ui-stable.js?v=0.31.10-test.1','./id-converter.html','./manifest.webmanifest','./app-icon.svg'];

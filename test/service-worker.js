const CACHE='kmreg-test-shell-0.31.10-test.45';
const SHARED_UI='./log-ui.css?v=0.31.10-test.45';
const SHELL=['./','./index.html','./log-json-v2.js?v=2.0.0',SHARED_UI,'./shell-ui.js?v=0.31.10-test.34','./shell-ui-stable.js?v=0.31.10-test.1','./shell-gestures.js?v=0.31.10-test.45','./id-converter.html','./manifest.webmanifest','./app-icon.svg','./config/modules.json','./time/index.html','./time/app.js','./time/styles.css','./time/home-layout.css','./time/home-layout.js','./time/home-top.css','./time/home-top.js'];
...
function injectShellScript(response){
  ...
  return response.text().then(html=>{
    if(!html.includes('log-ui.css'))html=html.replace('</head>',`<link rel="stylesheet" href="./log-ui.css?v=0.31.10-test.45"></head>`);
    let injection='';
    ...
    if(!html.includes('shell-gestures.js'))injection+=`<script src="./shell-gestures.js?v=0.31.10-test.45"></script>`;

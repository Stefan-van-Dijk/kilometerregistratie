const CACHE='kmreg-test-shell-0.31.10-test.60';
...
const DIRECT_ACTIONS='./shell-direct-actions.js?v=0.31.10-test.60';
...
function injectShellScript(response){
  ...
  return response.text().then(html=>{
    ...
    html=html.replace(/shell-direct-actions\.js\?v=[^"'<>]+/g,'shell-direct-actions.js?v=0.31.10-test.60');
    ...
    if(!html.includes('shell-direct-actions.js'))injection+=`<script src="./shell-direct-actions.js?v=0.31.10-test.60"></script>`;

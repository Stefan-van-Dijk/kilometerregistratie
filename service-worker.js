const CACHE='kmreg-shell-0.31.4';
const SHELL=['./','./index.html','./shell-ui.js?v=0.31.4','./shell-ui-stable.js?v=0.31.4','./id-converter.html','./manifest.webmanifest','./app-icon.svg'];

const CACHE='kmreg-shell-0.31.9';
const SHELL=['./','./index.html','./shell-ui.js?v=0.31.9','./shell-ui-stable.js?v=0.31.9','./id-converter.html','./manifest.webmanifest','./app-icon.svg'];

const CACHE='kmreg-shell-0.31.8';
const SHELL=['./','./index.html','./shell-ui.js?v=0.31.8','./shell-ui-stable.js?v=0.31.8','./id-converter.html','./manifest.webmanifest','./app-icon.svg'];

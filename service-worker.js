const CACHE='kmreg-shell-0.31.3';
const SHELL=['./','./index.html','./shell-ui.js','./shell-ui-stable.js','./id-converter.html','./manifest.webmanifest','./app-icon.svg'];
...
function injectShellScript(response){
  ...
  return response.text().then(html=>{
    ...
    if(!html.includes('shell-ui-stable.js'))injection+=`<script src="./shell-ui-stable.js"></script>`;

const CACHE='kmreg-shell-0.31.6';
const SHELL=['./','./index.html','./shell-ui.js?v=0.31.6','./shell-ui-stable.js?v=0.31.6','./id-converter.html','./manifest.webmanifest','./app-icon.svg'];
